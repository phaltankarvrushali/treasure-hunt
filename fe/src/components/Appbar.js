...
import SingleGame from "../pages/SinglePlayerGame/SinglePlayerGame"
        ...
        <Router history={history} title={title} >
          ...
          >
            ...
            <List>
              ...
              <ListItem button component={Link} to="/game" onClick={onItemClick('TAP TO PLAY')}>
                <ListItemIcon>
                  <LayersIcon />
                </ListItemIcon>
                <ListItemText primary="TAP TO PLAY" />
                { title === 'TAP TO PLAY' &&
                    <ListItemIcon>
                      <IconButton onClick={handleDrawerCollapsed}>
                        <ChevronLeftIcon />
              ...
              <ListItem button component={Link} to="/singlePlayer" onClick={onItemClick('SINGLE PLAYER GAME')}>
                <ListItemIcon>
                  <LayersIcon />
                </ListItemIcon>
          ...
          <main className={classes.content}>
            ...
            <Route path="/messages" component={THome} />
            ...
            <Route path="/singlePlayer" component={SingleGame} />
